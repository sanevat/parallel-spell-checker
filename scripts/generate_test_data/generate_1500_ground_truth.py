#!/usr/bin/env python3
"""
Generate 1500-word test files with typos from dictionary.
Creates exactly 1500 typos like the 500/1K/2K versions.
"""
...
def generate_test_files(num_typos: int = 1500):
    print("=" * 80)
    ...
    for lang, valid_words, dict_set, by_len, chars in [
        ...
        typo_file = BASE / f"data/test_texts/{'macedonian' if lang == 'mk' else 'english'}/{lang}_hunspell_typos_1500.txt"
        gt_file = BASE / f"data/ground_truth/{lang}_hunspell_corrections_1500.json"
