#!/usr/bin/env python3
"""
Generate 5000-word test files with typos from dictionary.
"""
...
def generate_test_files(num_typos: int = 5000):
    print("=" * 80)
    ...
    for lang, valid_words, dict_set, by_len, chars in [
        ...
        typo_file = BASE / f"data/test_texts/{'macedonian' if lang == 'mk' else 'english'}/{lang}_hunspell_typos_5000.txt"
        gt_file = BASE / f"data/ground_truth/{lang}_hunspell_corrections_5000.json"
