#!/usr/bin/env python3
"""
Run Levenshtein DICT-SPLIT benchmark for Turkish with 2 runs, taking the best result.
...
benchmark_script = base / "scripts" / "benchmarks_mpi" / "mpi_dict_split_turkish_levenshtein.py"
...
print("=" * 80)
print("LEVENSHTEIN TURKISH BENCHMARK - DICT-SPLIT STRATEGY")
    ...
    for num_procs in PROCS:
        ...
        for run in range(1, NUM_RUNS + 1):
            ...
            try:
                ...
                # Read temp file
                temp_file = results_dir / f"tr_levenshtein_dict_split_{size}_temp.json"
                if temp_file.exists():
