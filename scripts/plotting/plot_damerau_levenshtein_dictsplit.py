"""
Plot Damerau-Levenshtein Scalability - Dict-Split Results

Visualizes the dict-split benchmark results for Damerau-Levenshtein algorithm
...
ax.set_title('MPI Dict-Split Scalability: Damerau-Levenshtein Algorithm')
...
plt.savefig(output_dir / 'damerau_levenshtein_dictsplit_scalability.png', dpi=300, bbox_inches='tight',
            facecolor='white', edgecolor='none')
plt.savefig(output_dir / 'damerau_levenshtein_dictsplit_scalability.pdf', bbox_inches='tight',
            facecolor='white', edgecolor='none')

# Also save in main directory
plt.savefig(results_dir / 'damerau_levenshtein_dictsplit_scalability.png', dpi=300, bbox_inches='tight',
            facecolor='white', edgecolor='none')

print(f"Saved visualizations:")
print(f"  - {output_dir / 'damerau_levenshtein_dictsplit_scalability.png'}")
print(f"  - {output_dir / 'damerau_levenshtein_dictsplit_scalability.pdf'}")
print(f"  - {results_dir / 'damerau_levenshtein_dictsplit_scalability.png'}")

# Print summary statistics
print("\n--- Damerau-Levenshtein Dict-Split Performance Summary ---")
