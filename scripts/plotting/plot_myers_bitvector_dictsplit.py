"""
Plot Myers Bit-Vector Scalability - Dict-Split Results

Visualizes the dict-split benchmark results for Myers Bit-Vector algorithm
...
ax.set_title('MPI Dict-Split Scalability: Myers Bit-Vector Algorithm')
...
plt.savefig(output_dir / 'myers_bitvector_dictsplit_scalability.png', dpi=300, bbox_inches='tight',
            facecolor='white', edgecolor='none')
plt.savefig(output_dir / 'myers_bitvector_dictsplit_scalability.pdf', bbox_inches='tight',
            facecolor='white', edgecolor='none')

print(f"Saved visualizations:")
print(f"  - {output_dir / 'myers_bitvector_dictsplit_scalability.png'}")
print(f"  - {output_dir / 'myers_bitvector_dictsplit_scalability.pdf'}")

# Print summary statistics
print("\n--- Myers Bit-Vector Dict-Split Performance Summary ---")
