#!/usr/bin/env python3
"""
MPI Parallel Benchmark for Spell Checking - 1000 word version.
Progress reported every 100 words.
"""
...
def main():
    ...
    if rank == 0:
        ...
        # Load ground truth (1K word version)
        gt_mk = load_ground_truth(str(base / "data/ground_truth/mk_hunspell_corrections_1K.json"))
        gt_en = load_ground_truth(str(base / "data/ground_truth/en_hunspell_corrections_1K.json"))
    ...
    if rank == 0:
        ...
        output_file = results_dir / "mpi_1K_temp.json"
