#!/usr/bin/env python3
"""
MPI Text-Split Spell Checker for 250 test files.
"""
...
def main():
    ...
    if rank == 0:
        print("=" * 80)
        print(f"TEXT-SPLIT MPI-{size} BENCHMARK (250 words)")
        print("=" * 80)
    ...
    if rank == 0:
        ...
        with open(results_dir / "text_split_250_temp.json", 'w', encoding='utf-8') as f:
