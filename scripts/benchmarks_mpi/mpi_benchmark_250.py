#!/usr/bin/env python3
"""
MPI Parallel Benchmark for Spell Checking - 250 word version.
Progress reported every 25 words.
"""
...
def main():
    ...
    if rank == 0:
        ...
        # Load ground truth (250 word version)
    ...
    if rank == 0:
        ...
        output_file = results_dir / "mpi_250_temp.json"
