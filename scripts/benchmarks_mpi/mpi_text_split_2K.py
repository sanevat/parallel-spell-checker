#!/usr/bin/env python3
"""
MPI Text-Split Spell Checker for 2K test files.
Uses existing 2K typo files and ground truth.
"""
...
def main():
    ...
    if rank == 0:
        print("=" * 80)
        print(f"TEXT-SPLIT MPI-{size} BENCHMARK (2000 words)")
        print("=" * 80)
        ...
        # Load ground truth (2K word version)
    ...
    if rank == 0:
        ...
        output_file = results_dir / "text_split_2K_temp.json"
