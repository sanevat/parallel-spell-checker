#!/usr/bin/env python3
"""
MPI Text-Split Spell Checker for 3500 test files.
"""
...
def main():
    ...
    if rank == 0:
        print("=" * 80)
        print(f"TEXT-SPLIT MPI-{size} BENCHMARK (3500 words)")
        print("=" * 80)
        ...
        with open(base / "data/ground_truth/mk_hunspell_corrections_3500.json", 'r', encoding='utf-8') as f:
            gt_mk = json.load(f)
        with open(base / "data/ground_truth/en_hunspell_corrections_3500.json", 'r', encoding='utf-8') as f:
            gt_en = json.load(f)
    ...
    if rank == 0:
        ...
        with open(results_dir / "text_split_3500_temp.json", 'w', encoding='utf-8') as f:
