#!/usr/bin/env python3
"""
MPI Text-Split Spell Checker for 5000 test files.
"""
...
def main():
    ...
    if rank == 0:
        print("=" * 80)
        print(f"TEXT-SPLIT MPI-{size} BENCHMARK (5000 words)")
        print("=" * 80)
        ...
        with open(base / "data/ground_truth/mk_hunspell_corrections_5000.json", 'r', encoding='utf-8') as f:
            gt_mk = json.load(f)
    ...
    if rank == 0:
        ...
        with open(results_dir / "text_split_5000_temp.json", 'w', encoding='utf-8') as f:
