#!/usr/bin/env python3
"""Run Turkish Myers Bit-Vector TEXT-SPLIT for all sizes and process counts.
...
def run_single_benchmark(num_procs: int, size: str) -> dict:
    ...
    cmd = ["mpiexec", "-n", str(num_procs), "python", "-u",
           str(BASE / "scripts/benchmarks_mpi/mpi_text_split_turkish_myers.py"), size]
...
final_file = RESULTS_DIR / "tr_myers_best_results.json"
